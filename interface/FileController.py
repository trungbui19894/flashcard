...
def FileCtr():
    ...
    #tạo button
    globalVariable.down_sample_button = create_button("Download Sample File", 20, 20,lambda: export("sample"))
    globalVariable.up_file_button = create_button("Upload Your File", 20, 20, import_deck)
    globalVariable.imtomain_back_button = create_button("Back", 12, 5, lambda: back_main_screen("import"))