...
def Home():
    ...
    #tạo button
    globalVariable.library_button = create_button(globalVariable.window, "Library",25,10,main_to_library)
    globalVariable.import_button = create_button(globalVariable.window, "Import", 25,10,show_import_screen)
    globalVariable.exit_button = create_button(globalVariable.window, "Exit", 12, 5, close_window)