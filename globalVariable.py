...
def variableInitialize():
    ...
    # library
    global deck_label_frame, litomain_back_button, delete_deck_button, download_button, see_card_button, add_deck_button, study_button
    # see card
    global sctoli_back_button, add_card_button, delete_card_button
    # study
